# Writeup
The writeups in the folder were written as I was learning the mechanics of this project. They are structured primarily as walkthroughs and lectures rather than quick reference documentation. The notes were written in [Obsidian](https://obsidian.md/) style markdown, so may have slightly different looks between Github and Obsidian.
