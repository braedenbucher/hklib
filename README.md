...
Experimenta Windows kernel hook library using trampoline detours and atomic 16-byte inline patching. Allows authors to initialize trampolines for each detour, and restore them gracefully on driver exit.
